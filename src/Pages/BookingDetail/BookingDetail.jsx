...
const BookingDetail = () => {
  ...
  const [init,setInit]=React.useState({name:state.user?.name,email:state.user?.email,phoneno:state.user?.phoneNo,Message:"",state:"",city:"",building:"",address:""})
  const handleFormSubmit=(values)=>{
console.log(values);
console.log(clients*data.info?.Price)
bookingServices.addBooking({ NumberClients: Number,
  ...
  ServiceId:state.info._id,
  UserId:state.user._id,
  OwnerId: state.info.userid}).then((val)=>{
